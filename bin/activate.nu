...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/BenCohen/PycharmProjects/monocle-calendar-server'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/BenCohen/PycharmProjects/monocle-calendar-server/bin/deactivate.nu'
